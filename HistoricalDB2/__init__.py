...
def main(mytimer: func.TimerRequest) -> None:
    ...
    if getByStream:
        ...
        column_names = ['ContingencyRequired','AIL','CoalGen','GasGen','DualGen','HydroGen','OtherGen','StorageGen','WindGen']
        streamIds = [226,225,86,85,322684,87,23695,322677,23694]   
