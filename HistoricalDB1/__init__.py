...
def main(mytimer: func.TimerRequest) -> None:
    ...
    if getByStream:
        ...
        column_names = ['AlbertaTotalNetGeneration','SolarGen','BCMATLIMPORTATC','BCMATLEXPORTATC','SASKIMPORTATC','SASKEXPORTATC','SASKEXPORTGROSSOFFERS','SASKIMPORTGROSSOFFERS',
                        'BCMATLEXPORTGROSSOFFERS','BCMATLIMPORTGROSSOFFERS']
        streamIds = [84,322665,294451,294452,125,128,294418,294417,294442,224]
